// #include "AllStruct.h" 
#ifndef __SIM800C_GPRS_H
#define __SIM800C_GPRS_H
#include "stm32f10x.h"
#include "FreeRTOS.h"
#include "semphr.h"
...
#define HEARTPACKETSTRING  "\0\1"//心跳包内容，默认发4个字节长度
 ...
 //GPRS模块用的控制IO
#define GPRS_POWERKEY_H   GPIO_SetBits(GPRS_PORT, GPRS_PWR_PIN)		  //模块开关（SIM800C开关机设计及时序  PWRKEY 引脚内部有上拉电阻，程序中IO复位给低电平，电路集电极为高，即上电 ）
